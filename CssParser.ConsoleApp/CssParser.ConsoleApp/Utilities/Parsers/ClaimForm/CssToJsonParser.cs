...
{
    public class CssToJsonParser : ICssToJsonParser
    {
        ...
        {
            ParseSourceCssFiles(sourceFilesPath, INCLUDE_MODIFIED_CSS);
        }

        public void ParseSourceCssFile(string sourceFilePath, string currentFileName)
        {
            ParseSourceCssFile(sourceFilePath, currentFileName, INCLUDE_MODIFIED_CSS);
        }

        private void ParseSourceCssFiles(string sourceFilesPath, bool includeModifiedCss)
        {
        ...
        private void ParseSourceCssFile(string sourceFilePath, string currentFileName, bool includeModifiedCss)
        {
